...
Tags: ercaspay, verve, naira, mastercard, visa
...
Ercaspay lets businesses in Nigeria, Ghana, Kenya, and South Africa accept secure payments from local and global channels. Integrate today!

== Description ==

ercaspay makes it easy for businesses in Nigeria, Ghana, Kenya and South Africa to accept secure payments from multiple local and global payment channels. Integrate ercaspay with your store today, and let your customers pay you with their choice of methods.
...
* Modern, seamless payment experience via the ercaspay Checkout — [Try the demo!](https://ercaspay.com/demo/checkout)
...
Over 60,000 businesses of all sizes in Nigeria, Ghana, Kenya, and South Africa rely on ercaspay's suite of products to receive payments and make payouts seamlessly. Sign up on [ercaspay.com/signup](https://ercaspay.com/signup) to get started.
...
*	No subscription plans is created on ercaspay. The [WooCommerce Subscriptions](https://woocommerce.com/products/woocommerce-subscriptions/) plugin handles all the subscription functionality.
...
*   In the search box type __ercaspay WooCommerce Payment Gateway__
*   Click on Install now when you see __ercaspay WooCommerce Payment Gateway__ to install the plugin
*   After installation, __activate__ the plugin.


= ercaspay Setup and Configuration =
*   Go to __WooCommerce > Settings__ and click on the __Payments__ tab
*   You'll see ercaspay listed along with your other payment methods. Click __Set Up__
*   On the next screen, configure the plugin. There is a selection of options on the screen. Read what each one does below.

1. __Enable/Disable__ - Check this checkbox to Enable ercaspay on your store's checkout
...
*   A ercaspay merchant account—use an existing account or [create an account here](https://ercaspay.com/signup)
...
*	No subscription plans is created on ercaspay. The [WooCommerce Subscriptions](https://woocommerce.com/products/woocommerce-subscriptions/) handles all the subscription functionality.
...
= 5.8.2 - July 18, 2024 =
*   New: Introduce filter hook `wc_ercaspay_payment_channels`
...
*   Improve: Ensure order amount is in integer when initializing payment on ercaspay
...
*   Update: Load ercaspay InlineJS (Popup) V2 in the custom payment gateways

= 5.7.6 - June 20, 2023 =
*   New: Minimum WooCommerce supported version: 7.0
*   Fix: Unable to process refund on the view order screen
*   Improve: ercaspay test mode notice will now be displayed in the WooCommerce Admin Notes Inbox

= 5.7.5 - May 22, 2023 =
*   Update: Add support for EGP as an accepted currency
*   Update: Update icon for Kenyan payment methods
*   Update: Migrate to ercaspay InlineJS (Popup) V2
...
*   Fix: ercaspay payment modal displaying on the "Pay for Order" page
...
= 5.7.2 - March 12, 2021 =
* New: Auto display ercaspay payment popup on the payment page
* Removed: Remove ercaspay metrics tracker
...
* Fix: The default gateway should display only the payment channel(s) set on the ercaspay settings page
...
= 5.6.0 - August 7, 2019 =
*   New: Support for refunds via ercaspay from the order details screen.
*   New: Log successful transaction to ercaspay metrics tracker.
*   New: Add support for sending additional order details to ercaspay when making payment using a saved card.
*   New: Add support for sending additional order details to ercaspay when a subscription payment is renewed.
...
*   Misc: Remove ercaspay fee and ercaspay payout amount on the order details page
...
*   New: Add support for ercaspay split payments
*   New: Display ercaspay fee and ercaspay payout amount on the order details page
...
*	Fix: Deprecated functions in the Tbz_WC_Gateway_ercaspay_Subscription class
...
*	New: Add support for ercaspay custom filters
*	New: Create additional ercaspay gateways (max of 5) using different custom filters. You can create a gateway that accepts only Verve cards, a gateway that accepts only bank account payments, a gateway that accepts only GTB issued Mastercard.
...
= 4.0.0 - April 10, 2017 =
* 	New: Add support for ercaspay Inline Embed.
*  	New: Add support for sending additional order details to ercaspay

= 3.1.1 - February 13, 2017 =
* 	New: Changed ercaspay payment methods icon.

= 3.1.0 - January 10, 2017 =
* 	New: Add support for USD and GBP currency. Note this has to be enabled by ercaspay for your account before it can be used on your site.
...
= 2.0.1 - July 5, 2016 =
*	Fix: ercaspay payment option and settings not available if ercaspay WooCommerce Payment Gateway version 2.0.0 is installed and WooCommerce version 2.5.5 and below is installed

= 2.0.0 - June 28, 2016 =
* 	New: Saved cards - allow store customers to save their card details and pay again using the same card. Card details are saved on ercaspay servers and not on your store.
*	Fix: Change payment icon

= 1.1.0 - April 22, 2016 =
*   Fix: Fatal error if the WooCommerce plugin is deactivated while the ercaspay plugin is active
...
1. ercaspay displayed as a payment method on the WooCommerce payment methods page
