...
Ercaspay for WooCommerce allows your store in Nigeria, Ghana, Kenya, or South Africa to accept secure payments from multiple local and global payment channels.
...
*   A Ercaspay merchant account—use an existing account or [create an account here](https://merchant.ercaspay.com/auth/register)
