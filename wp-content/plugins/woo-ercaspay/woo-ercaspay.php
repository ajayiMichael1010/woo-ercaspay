 ...
 *
 * @wordpress-plugin
 * Plugin Name:       ErcasPay WooCommerce Payment Gateway
...
define( 'WC_ERCASPAY_VERSION', '5.8.0' );
...
function tbz_wc_ercaspay_init() {
	...
	require_once dirname(__FILE__) . '/includes/class-wc-gateway-ercaspay.php';
